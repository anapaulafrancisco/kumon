                    ...
                    <div class="col-md-12 col-sm-12 col-xs-12">
                        <div class="box box-primary">
                            ...
                            <div class="box-header with-border">
                                <h3 class="box-title">Incluir Pessoa</h3>
                            </div>

                            <?php echo Notificacao::getNotificacao(); ?>  

                            <form name="frmPessoa" id="frmPessoa" action="<?php echo base_url('pessoa/incluir/salvar'); ?>" method='post' class="form-horizontal">
                                <div class="box-body">
                                        ...
                                        <div class='col-md-6 col-sm-6 col-xs-12'>
                                            <select name="sltTipo" id="sltTipo" class="form-control">
                                                <?php 
                                                    ...
                                                    {
                                                        $repopular = set_select('sltTipo', $tipo);
                                                        echo "<option value='{$tipo}' {$repopular} >{$tipo}</option>";
                                                    } 
                                                ?>
                                            </select>
                                        </div>
                                    ...
                                    <div class='form-group'>
                                        ...
                                        <div class='col-md-6 col-sm-6 col-xs-12'>
                                            <label><input type='radio' class='flat' name='rdoStatusPessoa' value='1' <?php echo set_radio('rdoStatusPessoa', '1', TRUE); ?>> Ativo</label><br />
                                            <label><input type='radio' class='flat' name='rdoStatusPessoa' value='0' <?php echo set_radio('rdoStatusPessoa', '0'); ?>> Inativo</label>
                                        </div>	
                                    </div>
